...
class PixelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pixel" do
    assert_difference('Pixel.count') do
      post pixels_url, params: { pixel: { description: @pixel.description, name: @pixel.name, tags: @pixel.tags, tracks_id: @pixel.tracks_id } }
    end
  ...
  test "should update pixel" do
    patch pixel_url(@pixel), params: { pixel: { description: @pixel.description, name: @pixel.name, tags: @pixel.tags, tracks_id: @pixel.tracks_id } }
